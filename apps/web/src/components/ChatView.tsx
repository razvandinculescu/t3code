          ...
          >
            ...
            <div className="relative flex min-h-0 flex-1 flex-col">
              {/* Messages — LegendList handles virtualization and scrolling internally.
                  Rows read the disclosure settings at mount; before hydration those
                  are the schema defaults, so mounting early would lay the list out
                  collapsed and then grow every row at once when the persisted values
                  land, right while the initial scroll to the end is settling. */}
              {clientSettingsHydrated ? (
                <MessagesTimeline
